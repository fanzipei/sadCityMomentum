...
def citymomentum(cur_t):
    ...
    with open('./user_cluster_newyear/usercluster_{}.csv'.format(cur_t),'r') as f:
    ...
    for i in xrange(6):
        ...
        with open('./10min_newyear_sorted/D{}T{}.csv'.format((i-5+cur_t)/144,(i-5+cur_t)%144),'r') as f_data:
    ...
    with open('comparison_newyear/output_{}.csv'.format(cur_t),'w') as f:
